...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ALTimer"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ALTimer."
  ...
  spec.author             = { "Lost-souls" => "hy15816@gmail.com" }
  # Or just: spec.author    = "Lost-souls"
  # spec.authors            = { "Lost-souls" => "hy15816@gmail.com" }
  ...
  spec.source_files  = "ALTimer", "ALTimer/**/*.{h,m}"
